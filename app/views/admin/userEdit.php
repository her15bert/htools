...
<form role="form" method="post" style="width: 50%;">
  <div class="form-group">
    ...
    <input name="username" type="text" class="form-control" id="username" value="<?php echo $data['user']->username;?>">
  </div>
  <div class="form-group">
    ...
    <input name="email" type="text" class="form-control" id="email" value="<?php echo $data['user']->email;?>">
  </div>
