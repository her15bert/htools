...
class Url {
	 ...
	 */
	public static function templatedefault_path(){
		return DIR.'app/templates/'.Session::get('template').'/';
	}
    public static function template_path(){
		return DIR.'app/templates/';
	}
	public static function bootstrap_path(){
		return DIR.'vendor/bootstrap/dist/';
	}
	public static function jquery_path(){
		return DIR.'vendor/jquery/';
	}
	/**
